...
class LSTNet(nn.Module):
    ...
    def forward(self, X):
        ...
        for i in range(len(self.skip_steps)):
            ...
            S = S.view(S.size(0), S.size(1), skip_sequence_len, skip_step) # [batch_size, conv1_out_channels, skip_sequence_len, skip_step]
            S = S.permute(0, 3, 2, 1).contiguous() # [batch_size, skip_step, skip_sequence_len, conv1_out_channels]
